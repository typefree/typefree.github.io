(() => {
  const copy = {
    en: {
      ...
      "safety-title": "When danger is close, put people first.", "safety-copy": "Amenige is an unofficial app that supports decisions about moving a car; it is not an evacuation notice. Do not go to retrieve your car if roads are flooded or heavy rain has begun. Check the latest information from JMA, local authorities, and the conditions around you.",
